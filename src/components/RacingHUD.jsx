    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed top-4 left-4 md:left-6 z-30 pointer-events-none"
            >
            ...
            <motion.div
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ delay: 0.5, duration: 0.8 }}
                className="fixed top-4 right-4 md:right-6 z-30 pointer-events-none hidden md:block"
            >
                <div className="hud-panel rounded-lg px-4 py-2 pointer-events-auto">
            ...
            <motion.div
                ...
                className="fixed left-6 top-1/2 -translate-y-1/2 z-30 pointer-events-none hidden lg:block"
            >
                <div className="hud-panel rounded-lg p-3">
                    {/* Vertical speed bar */}
                    <div className="h-32 w-3 bg-carbon-50 rounded-full overflow-hidden relative mb-2">
                        <motion.div
                    ...
                    <div className="text-center">
                        <div className="font-racing text-xl text-white">{speed}</div>
            ...
            <motion.div
                ...
                className="fixed bottom-4 md:bottom-6 left-1/2 -translate-x-1/2 z-30 pointer-events-none"
            >
